...
function WordEncode(props) {
    ...
    const fetchData = async () => {
        const response = await fetch(getUrlByEnv(`/licence/logicer/word-encode?word=${text}`), {
            method: "GET",
            credentials: 'include'
        });
